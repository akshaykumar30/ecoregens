...
function sticky_header(){
	if(jQuery('.sticky-header').length){
		...
		console.log("calling from stickey");
	}
}
...
//  > Top Search bar Show Hide function by = custom.js =================== //	
	...
	function site_search2(){
		jQuery('a[id="#search-two"]').on('click', function(event) {                    
...
===========================*/
	...
	jQuery(document).on('submit', 'form.cons-contact-form', function(e){
		...
		/* sending message */
		jQuery.ajax({
			url: 'https://thewebmax.com/angular/industro/form-handler2.php',
...
function setupProductDetailSlider() {
